export class OrderPage extends HTMLElement {
	...
	render() {
		...
		// We need to call this.root, not document, because the form is in the shadow DOM.
	...
	setFormBinding(form) {
		...
		// Set double data binding. If we change the user, we change the form.
		...
		// If we change the form, we change the user.
